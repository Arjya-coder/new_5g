...
# ============================================================================
# ALGORITHM 1 (PHASE-2 BASELINE ENGINE USED INSIDE RL ENV)
# ============================================================================

class Algorithm1:
    """
    Lightweight handover decision core used by PPO environment rollouts.
    """
    ...
    def step(
        ...
        if MUST_HO:
            if eligible_candidates:
                ...
                if len(neighbor_ids) > 0:
                    candidates_valid = [
                        (i, self.rsrp_n_f[neighbor_ids[i]])
